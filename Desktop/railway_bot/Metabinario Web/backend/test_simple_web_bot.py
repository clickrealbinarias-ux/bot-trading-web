#!/usr/bin/env python3
"""
Script de prueba para el web bot simplificado
"""
...
# Configuración
WEB_BOT_URL = "http://127.0.0.1:5005/api"
...
def test_simple_web_bot():
    """Probar el web bot simplificado"""
    logger.info("🧪 INICIANDO PRUEBA DEL WEB BOT SIMPLIFICADO")
    logger.info("=" * 60)
    ...
    if system_status:
        logger.info(f"✅ Trader conectado: {system_status.get('trader_connected', False)}")
    ...
    logger.info("1. Abre el navegador en http://127.0.0.1:5004")
